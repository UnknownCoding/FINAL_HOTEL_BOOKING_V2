...
const BookingForm = ({currentUser,paymentIntent}:Props) => {
    ...
    const {mutate:bookRoom,isLoading} = useMutation(apiClient.createRoomBooking,{
        ...
        onError:()=>{
            showToast({message:"Error saving the booking",type:"ERROR"});
        }
    })
    ...
    const onSubmit = async (formData:BookingFormData) =>{
        ...
        if(result.paymentIntent?.status == "succeeded"){
            // most up to date paymentIntentId
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-5 rounded-lg border border-slate-300 p-4 ">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <label className="text-gray-700 text-sm font-bold w-full flex-1 col-span-2 ">
                    Email
            ...
            <div className="space-y-2">
                ...
                <div className="bg-blue-200 p-4 rounded-md">
                    <div className="font-semibold text-lg">
                        Total Cost: AED {paymentIntent.totalCost.toFixed(2)}
                    </div>
            ...
            <div className="space-y-2">
                <h3 className="text-xl font-semibold">Payment Detials</h3>
                <CardElement id="payment-element" className="border rounded-md p-2 text-sm" />
            </div>
            <div className="flex justify-end">
                <button disabled={isLoading} type="submit" className="bg-blue-600 disabled:bg-gray-500 text-white p-2 font-bold hover:bg-blue-500 text-base">
