...
const SearchResultCard = ({hotel}:Props) => {
    return (
        // 2/5th of the space means 2fr , 3/5th of the space means 3fr
        <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-8 gap-8">
            <div className="w-full h-[300px]">
                <img src={hotel.imageUrls[0]} className="w-full h-full object-cover object-center" alt="Error404"/>
            </div>
            <div className="grid grid-rows-[1fr_2fr_1fr]">
                ...
                {/* any text wont jump to a new line inside the div */}
                <div className="grid grid-cols-2 whitespace-nowrap items-end">
                    ...
                    <div className="flex flex-col items-end gap-1">
                        <span className="font-bold">
                            AED {hotel.pricePerNight} per night
                        </span>
